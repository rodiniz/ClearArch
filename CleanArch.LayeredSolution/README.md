...
- Database initialization is optimized for convenience over production discipline: `EnsureCreated()` helps local startup, but it can bypass the normal migration workflow and should usually be replaced with migrations in real deployments.
